 ...
 *
 * @param   {Number} serverId Server to create database on
 * @returns {Promise}
 */
exports.createDatabase = function(serverId) {
	return agent.put(`/api/server/${serverId}/database`)
		.use(prefix);
};
 ...
 *
 * @param   {Number} serverId Server to delete database on
 * @returns {Promise}
 */
exports.deleteDatabase = function(serverId) {
	return agent.delete(`/api/server/${serverId}/database`)
		.use(prefix);
};
...
/**
 * Servers : Get Game Types
 *
 * @returns {Promise}
 */
exports.getGameTypes = function(game) {
	return agent.get(`/api/game/${game}/types`)
		.use(prefix);
};

/**
 * Servers : Set Game Type
 *
 * @param {Number} serverId Server id to set game type to
 * @param {Object} type     Game type information
 * @returns {Promise}
 */
exports.setType = function(serverId, type) {
	return agent.post(`/api/server/${serverId}/type`)
		.use(prefix)
		.send(type);
};
